    ...
    <div className="min-h-screen pb-20 relative z-10 bg-gradient-to-br from-purple-500 to-orange-400">
      ...
      <Tabs defaultValue="connections" className="w-full">
        <TabsList className="w-full bg-white/10 backdrop-blur-md border-b border-white/20 rounded-none h-12">
          <TabsTrigger value="connections" className="flex-1 data-[state=active]:bg-white/20 data-[state=active]:text-white text-white/70" data-testid="tab-connections">
        ...
        {/* Connections Tab */}
        <TabsContent value="connections" className="mt-0 px-4 pt-4">
